...
//           console.log("addBookAndUpdateUI  book :", book );
//      } catch (error) {
//           console.log("addBookAndUpdateUI  error:", error);
...
async function removeBook(bookId) {
     ...
     const responseOfRemove = await fetch(url, options);
     return responseOfRemove;
   };
